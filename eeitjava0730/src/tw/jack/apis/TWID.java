...
public class TWID {
	private String id;
	static String letters = "ABCDEFGHJKLMNPQRSTUVWXYWZIO"; // 加上static是整個類別共同擁有
	...
	public TWID(char area) {
		this(new Random(26).nextInt(2) == 0, area);
	}
	...
	public static TWID newTWID(String id) {
		if(isRight(id)) {
			return new TWID(id); // throw new Exception();
		}else {
			return null;
		}
	}
...
//			String letters = "ABCDEFGHJKLMNPQRSTUVWXYWZIO"; // 這邊是區域變數
			char c1 = id.charAt(0);
